...
# A screenshot no longer takes that branch -- it opens in the tensaku editor
# instead -- and the app name here is what keeps a recording out of it: there is
# nothing to annotate in an mp4.
